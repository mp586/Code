...
HPC = 'no'
control_dir = 'square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_plus_uniform_warming_and_2xCO2_spinup_361'
...
plt.title('2C - AM (perturbed)', fontsize = med)
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/two_continents_newbucket_fixedSSTs_from_realworld_zonallysymm_plus_uniform_warming_and_2xCO2_spinup_361/w3000_2C-AM_control.png')
...
axes[0].set_title('Two continents perturbed (2C)', fontsize = med)
...
axes[1].set_title('America perturbed (AM)', fontsize = med)
...
axes[2].set_title('2C - AM perturbed', fontsize = med)
...
cbar.ax.tick_params(labelsize=small)
cbar.set_label('$\Delta RH$ (%)', size = med)
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/two_continents_newbucket_fixedSSTs_from_realworld_zonallysymm_plus_uniform_warming_and_2xCO2_spinup_361/w3000_2C_AM_and_2C-AM_control.png')
