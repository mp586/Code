...
HPC = 'no'
control_dir = 'two_continents_newbucket_fixedSSTs_zonally_symmetric_EqMax'
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
    control_dir= control_model + '/ISCA_HPC/' + control_dir
else: 
    control_dir= control_model + '/' + control_dir
...
HPC = 'no'
testdir_in1= 'two_continents_newbucket_fixedSSTs_zonally_symmetric_EqMax_plus_2pt52K_and_2xCO2_spinup_361'
runmin=120
runmax=480
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/full_continents_newbucket_fixedSSTs_zonally_symmetric_EqMax_plus_2pt52K_and_2xCO2_spinup_361/Pavg_minus_ctl_2panels_RCEqmax_vs_2CEqmax_P-Econts_120-480.png', bbox_inches='tight', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/Isca/full_continents_newbucket_fixedSSTs_zonally_symmetric_EqMax_plus_2pt52K_and_2xCO2_spinup_361/Pavg_minus_ctl_2panels_RCEqmax_vs_2CEqmax_P-Econts_120-480.svg', bbox_inches='tight', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/Isca/full_continents_newbucket_fixedSSTs_zonally_symmetric_EqMax_plus_2pt52K_and_2xCO2_spinup_361/Pavg_minus_ctl_2panels_RCEqmax_vs_2CEqmax_P-Econts_120-480.pdf', bbox_inches='tight', dpi=100)
