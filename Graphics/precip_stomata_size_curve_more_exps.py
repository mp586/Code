...
for k in range(len(minlats)):
	...
	for j in range(len(pert_list)):
		plt.plot([3,6,12,24,40,60,100],precip_pert_matrix[:,j], '*', label = pert_list[j])
		plt.plot([3,6,12,24,40,60,100],precip_ctl_matrix[:,j], '.', label = ctl_list[j])
	...
	for j in range(len(pert_list)):
		plt.plot([3,6,12,24,40,60,100],(precip_pert_matrix[:,j] - precip_ctl_matrix[:,3])/precip_ctl_matrix[:,3], '.', label = pert_list[j])
	plt.legend()
	...
	for j in range(len(pert_list)):
		plt.plot([3,6,12,24,40,60,100],(precip_pert_matrix[:,j] - precip_ctl_matrix[:,3]), '.', label = pert_list[j])
	plt.legend()
	plt.plot([3,6,12,24,40,60,100],[0,0,0,0,0,0,0],'k')
	plt.ylim([-4., 4.])
	plt.xlabel('Continental extent ($^{\circ}$ lon)')
	...
	for j in range(len(pert_list) - 1):
		...
		plt.plot([3,6,12,24,40,60,100],[0,0,0,0,0,0,0],'k')
		plt.plot([3,6,12,24,40,60,100],warming_only,'b*', label = 'warming (SB_p - SB_c)')
		plt.plot([3,6,12,24,40,60,100],stomata_only,'g*', label = 'stomata (vp_c - SB_c)')
		plt.plot([3,6,12,24,40,60,100],addition,'r*', label = 'addition')
		plt.plot([3,6,12,24,40,60,100],full,'m*', label = 'full change (vp_p - SB_c)')
		plt.legend()
		plt.ylim([-4., 4.])
		plt.xlabel('Continental extent ($^{\circ}$ lon)')
		plt.ylabel('Abs. $\Delta$P per Area (mm/d/m$^2$)')
