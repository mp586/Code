...
for k in range(len(minlats)):
	...
	for j in range(len(pert_list) - 1):
		...
		axes[0].plot([3,12,24,40,60,100],precip_ctl_matrix_del6[:,4], '*', markersize = 10., label = 'SB ctl')
		axes[0].plot([3,12,24,40,60,100],precip_pert_matrix_del6[:,4], '*', markersize = 10., label = 'SB pert')
		axes[0].plot([3,12,24,40,60,100],precip_pert_matrix_del6[:,2], '*', markersize = 10., label = 'VP05 pert')
		...
		axes[1].plot([3,12,24,40,60,100],[0,0,0,0,0,0],'k')
		axes[1].plot([3,12,24,40,60,100],warming_only,'b*', markersize = 10.,label = 'warming (SB pert - ctl)')
		axes[1].plot([3,12,24,40,60,100],stomata_only,'g*', markersize = 10.,label = 'stomata ('+pert_list[j]+' ctl - SB ctl)')
		axes[1].plot([3,12,24,40,60,100],addition,'r*', markersize = 10.,label = 'warming + stomata')
		axes[1].plot([3,12,24,40,60,100],full,'m*', markersize = 10.,label = 'full change ('+pert_list[j]+' pert - SB ctl)')
