...
HPC = 'no'
control_dir = 'aaquaplanet_noseasons_0qflux_landcp_equals_oceancp50_samealbedo_lepref0_commit7bb4387'
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
    exp1_name = 'ISCA_HPC/'+testdir_in1
    control_dir= control_model + '/ISCA_HPC/' + control_dir
else: 
...
uwind = (ucomp1_avg_ctl - ucomp4_month_avg_ctl)
wwind = ((wcomp1_avg_ctl - wcomp4_avg_ctl)*1000.)[::-1,:,:]
array = (rh1_avg_ctl - rh4_avg_ctl)
lons = uwind.lon 
lats = uwind.lat
pres = wwind.pres_lev
...
uwind = (ucomp2_avg_ctl - ucomp4_avg_ctl)
wwind = ((wcomp2_avg_ctl - wcomp4_avg_ctl)*1000.)[::-1,:,:]
array = (rh2_avg_ctl - rh4_avg_ctl)
lons = uwind.lon
lats = uwind.lat
pres = wwind.pres_lev
presar = array.pres_lev # need separate z coords for winds because read them in in reverse z order to flip axis
...
wwind = ((wcomp3_avg_ctl - wcomp4_avg_ctl)*1000.)[::-1,:,:]
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/squareland_noseasons_0qflux_landcp_equals_oceancp50_samealbedo_lepref0/w1000_three_albedo_cases_minus_aquaplanet_relhum.png')
...
# panel 1: Only South America 
uwind = (ucomp1_avg_ctl - ucomp4_avg_ctl)
wwind = ((wcomp1_avg_ctl - wcomp4_avg_ctl)*1000.)[::-1,:,:]
array = (temp1_avg_ctl - temp4_avg_ctl)
lons = uwind.lon 
lats = uwind.lat
pres = wwind.pres_lev
presar = array.pres_lev # need separate z coords for winds because read them in in reverse z order to flip axis
...
uwind = (ucomp2_avg_ctl - ucomp4_avg_ctl)
wwind = ((wcomp2_avg_ctl - wcomp4_avg_ctl)*1000.)[::-1,:,:]
array = (temp2_avg_ctl - temp4_avg_ctl)
lons = uwind.lon
lats = uwind.lat
pres = wwind.pres_lev
presar = array.pres_lev # need separate z coords for winds because read them in in reverse z order to flip axis
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/squareland_noseasons_0qflux_landcp_equals_oceancp50_samealbedo_lepref0/w1000_three_albedo_cases__minus_aquaplanet_temperature.png')
...
uwind = (ucomp1_avg_ctl - ucomp4_avg_ctl)
wwind = ((wcomp1_avg_ctl - wcomp4_avg_ctl)*1000.)[::-1,:,:]
array = (sphum1_avg_ctl - sphum4_avg_ctl)
lons = uwind.lon 
lats = uwind.lat
pres = wwind.pres_lev
presar = array.pres_lev # need separate z coords for winds because read them in in reverse z order to flip axis
...
uwind = (ucomp2_avg_ctl - ucomp4_avg_ctl)
wwind = ((wcomp2_avg_ctl - wcomp4_avg_ctl)*1000.)[::-1,:,:]
array = (sphum2_avg_ctl - sphum4_avg_ctl)
lons = uwind.lon
lats = uwind.lat
pres = wwind.pres_lev
presar = array.pres_lev # need separate z coords for winds because read them in in reverse z order to flip axis
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/squareland_noseasons_0qflux_landcp_equals_oceancp50_samealbedo_lepref0/w1000_three_albedo_cases__minus_aquaplanet_sphum.png')
