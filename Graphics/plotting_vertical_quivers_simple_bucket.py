...
HPC = 'yes'
control_dir = 'flat_continents_newbucket_fixedSSTs_zonally_symmetric'
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
    control_dir= control_model + '/ISCA_HPC/' + control_dir
else: 
    control_dir= control_model + '/' + control_dir
...
HPC = 'yes'
testdir_in1= 'flat_continents_newbucket_fixedSSTs_zonally_symmetric_plus_2pt52K_and_2xCO2_spinup_361'
runmin=24
runmax=120
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
axes[0].set_title('Realistic Continents (RC)', fontsize = med)
...
axes[1].set_title('Flat continents (FC)', fontsize = med)
...
axes[2].set_title('Two Continents (2C)', fontsize = med)
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/two_continents_newbucket_fixedSSTs_from_realworld_zonallysymm_plus_uniform_warming_and_2xCO2_spinup_361/w8000_RC_Flat_2C_veg05_pert_minus_control.png')

any_configuration_plot(outdir,runmin,runmax,-90.,90.,rh3_avg[39,:,:] - rh3_avg_ctl[39,:,:],area_array,'%','rh_avg_minus_ctl_lev39_2C','rainnorm',landmaskxr,nmb_contours=5, minval=-10., maxval = 10.)
any_configuration_plot(outdir,runmin,runmax,-90.,90.,rh1_avg[39,:,:] - rh1_avg_ctl[39,:,:],area_array,'%','rh_avg_minus_ctl_lev39_RC','rainnorm',landmaskxr,nmb_contours=5, minval=-10., maxval = 10.)
any_configuration_plot(outdir,runmin,runmax,-90.,90.,rh2_avg[39,:,:] - rh2_avg_ctl[39,:,:],area_array,'%','rh_avg_minus_ctl_lev39_FC','rainnorm',landmaskxr,nmb_contours=5, minval=-10., maxval = 10.)
