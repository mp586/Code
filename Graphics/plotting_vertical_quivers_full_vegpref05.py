...
axes[0].set_title('full continents control', fontsize = med)
...
axes[1].set_title('full continent perturbed', fontsize = med)
...
axes[2].set_title('full continents perturbed - control', fontsize = med)
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/full_continents_newbucket_fixedSSTs_zonally_symmetric_vegetation_vegpref05_plus_2pt52K_and_2xCO2_spinup_361/w3000_SQ_control_perturbed_delta.png')
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/full_continents_newbucket_fixedSSTs_zonally_symmetric_vegetation_vegpref05_plus_2pt52K_and_2xCO2_spinup_361/w3000_SQ_perturbed-control_lower_atmosphere.png')
