...
HPC = 'yes'
testdir_in1= 'square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_corrected_vegpref02_plus_uniform_warming_and_2xCO2_spinup_361_commit7bb4387/'
runmin=120
runmax=480
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
HPC = 'yes'
testdir_in1= 'square_Africa_newbucket_fixedSSTs_from_realworld_zonallysymm_corrected_vegpref02_plus_uniform_warming_and_2xCO2_spinup_361_commit7bb4387/'
runmin=120
runmax=480
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
    exp1_name = 'ISCA_HPC/'+testdir_in1
...
axes[0,0].set_title('(a) America only (AM) VP05', size = med)
#fig = plt.figure()
...
axes[0,1].set_title('(b) Africa only (AF) VP05', size = med)
#fig = plt.figure()
...
axes[1,0].set_title('(c) Two continents (2C) VP05', size = med)
#fig = plt.figure()
...
axes[1,1].set_title('(d) 2C - AM VP05', size = med)
#fig = plt.figure()
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_corrected_vegpref02_plus_uniform_warming_and_2xCO2_spinup_361_commit7bb4387/P_avg_minus_Ctl_4cases_120-480.png')
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_corrected_vegpref02_plus_uniform_warming_and_2xCO2_spinup_361_commit7bb4387/P_avg_minus_Ctl_4cases_120-480.svg')
