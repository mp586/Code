...
HPC = 'yes'
control_dir = 'full_continents_lepref07_fixedSSTs_zonally_symmetric'
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
    control_dir= control_model + '/ISCA_HPC/' + control_dir
else: 
    control_dir= control_model + '/' + control_dir
...
HPC = 'yes'
testdir_in1= 'full_continents_lepref07_fixedSSTs_zonally_symmetric_plus_2pt52K_and_2xCO2_spinup_361'
runmin=120
runmax=480
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
v_ctl = np.linspace(0.,8.,21)
nmb_contours = [-2.,1.,2.]

# RC 

array = precipitation1_avg_ctl
ctl_array = precipitation1_avg_ctl
...
axes[0].set_title('(a) RC ctl', size = med)
#fig = plt.figure()
...
cs = m.contourf(xi,yi,array, v_ctl, cmap='Blues', extend = 'max')
...
ctl_array = precipitation2_avg_ctl
...
axes[1].set_title('(b) RC07 ctl', size = med)
#fig = plt.figure()
...
cbar = fig.colorbar(cs, orientation = 'vertical', ax = [axes[0], axes[1]]) # usually on right 
...
array = precipitation1_avg_ctl - precipitation2_avg_ctl
...
axes[2].set_title('(c) RC ctl - RC07 ctl', size = med)
#fig = plt.figure()
...
# Add Colorbar
cbar = fig.colorbar(cs, orientation = 'vertical', ax = axes[2]) # usually on right 
cbar.set_label('mm/d', size=med)
cbar.ax.tick_params(labelsize=med)

fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/full_continents_newbucket_fixedSSTs_zonally_symmetric_plus_2pt52K_and_2xCO2_spinup_361_withtopo/P_ctl_2panels_RC_vs_RC07_Pctl_conts_40S40N_120-480.png', bbox_inches='tight', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/full_continents_newbucket_fixedSSTs_zonally_symmetric_plus_2pt52K_and_2xCO2_spinup_361_withtopo/P_ctl_2panels_RC_vs_RC07_Pctl_conts_40S40N_120-480.svg', bbox_inches='tight', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/full_continents_newbucket_fixedSSTs_zonally_symmetric_plus_2pt52K_and_2xCO2_spinup_361_withtopo/P_ctl_2panels_RC_vs_RC07_Pctl_conts_40S40N_120-480.pdf', bbox_inches='tight', dpi=400)
