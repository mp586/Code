...
axes[0,0].set_title('America only (AM)', fontsize = med)
# Africa Only 
...
axes[0,1].set_title('Africa only (AF)', fontsize = med)
...
axes[1,0].set_title('Two Continents (2C)', fontsize = med)
...
axes[1,1].set_title('2C - AM', fontsize = med)
