...
HPC = 'yes'
control_dir = 'withtv/square_South_America_frierson_insolation_newbucket_0qflux_samealbedo_samehcp_landocean_commitd15c267'
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
    control_dir= control_model + '/ISCA_HPC/' + control_dir
else: 
    control_dir= control_model + '/' + control_dir
...
HPC = 'yes'
testdir_in1= 'withtv/square_South_America_frierson_insolation_newbucket_0qflux_samealbedo_samehcp_landocean_plus_2xCO2_spinup_361_commitd15c267'
runmin=120
runmax=480
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
    exp1_name = 'ISCA_HPC/'+testdir_in1
...
omega3_avg = omega2_avg_ctl
rh3_avg = rh2_avg_ctl
sphum3_avg = sphum2_avg_ctl
temp3_avg = temp2_avg_ctl
ucomp3_avg = ucomp2_avg_ctl

omega3_avg_ctl = omega1_avg_ctl
rh3_avg_ctl = rh1_avg_ctl
sphum3_avg_ctl = sphum1_avg_ctl
temp3_avg_ctl = temp1_avg_ctl
ucomp3_avg_ctl = ucomp1_avg_ctl

# [omega3,omega3_avg,omega3_seasonal_avg,omega3_month_avg,omega3_annual_avg,time]=[omega2_ctl,omega2_avg_ctl,omega2_seasonal_avg_ctl,omega2_month_avg_ctl,omega2_annual_avg_ctl,time]
# [rh3,rh3_avg,rh3_seasonal_avg,rh3_month_avg,rh3_annual_avg,time]=[rh2_ctl,rh2_avg_ctl,rh2_seasonal_avg_ctl,rh2_month_avg_ctl,rh2_annual_avg_ctl,time]
...
# [ucomp3,ucomp3_avg,ucomp3_seasonal_avg,ucomp3_month_avg,ucomp3_annual_avg,time]=[ucomp2_ctl,ucomp2_avg_ctl,ucomp2_seasonal_avg_ctl,ucomp2_month_avg_ctl,ucomp2_annual_avg_ctl,time]
...
# [omega3_ctl,omega3_avg_ctl,omega3_seasonal_avg_ctl,omega3_month_avg_ctl,omega3_annual_avg_ctl,time]=[omega1_ctl,omega1_avg_ctl,omega1_seasonal_avg_ctl,omega1_month_avg_ctl,omega1_annual_avg_ctl,time]
# [rh3_ctl,rh3_avg_ctl,rh3_seasonal_avg_ctl,rh3_month_avg_ctl,rh3_annual_avg_ctl,time]=[rh1_ctl,rh1_avg_ctl,rh1_seasonal_avg_ctl,rh1_month_avg_ctl,rh1_annual_avg_ctl,time]
...
# [ucomp3_ctl,ucomp3_avg_ctl,ucomp3_seasonal_avg_ctl,ucomp3_month_avg_ctl,ucomp3_annual_avg_ctl,time]=[ucomp1_ctl,ucomp1_avg_ctl,ucomp1_seasonal_avg_ctl,ucomp1_month_avg_ctl,ucomp1_annual_avg_ctl,time]
...
HPC = 'yes'
testdir_in1= 'withtv/square_South_America_frierson_insolation_newbucket_0qflux_samealbedo_to_01land_samehcp_landocean_commitd15c267'
dire = testdir_in1
runmin=120
runmax=480
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
omega4_avg = data.omega
rh4_avg = data.rh
sphum4_avg = data.sphum
ucomp4_avg = data.ucomp
temp4_avg = data.temp


omega4_avg_ctl = omega2_avg_ctl
rh4_avg_ctl = rh2_avg_ctl
sphum4_avg_ctl = sphum2_avg_ctl
temp4_avg_ctl = temp2_avg_ctl
ucomp4_avg_ctl = ucomp2_avg_ctl
...
wcomp4_avg = - (omega4_avg * temp4_avg * Rspec)/(pfull * g)
...
quiver_plots_4_seperate_cases(runmin, runmax, 'ucorr_interplevs_quivers_4cases_deltarh_fct_latweights_', dire, 'BrBG', landmaskxr, '$\Delta$ r (%)', ucomp1_avg, ucomp1_avg_ctl, wcomp1_avg, wcomp1_avg_ctl, ucomp2_avg, ucomp2_avg_ctl, wcomp2_avg, wcomp2_avg_ctl, ucomp3_avg, ucomp3_avg_ctl, wcomp3_avg, wcomp3_avg_ctl, ucomp4_avg, ucomp4_avg_ctl, 
...
quiver_plots_4_seperate_cases(runmin, runmax, 'ucorr_interplevs_quivers_4cases_deltasphum_fct_latweights_', dire, 'BrBG', landmaskxr, '$\Delta$ q (g/kg)', ucomp1_avg, ucomp1_avg_ctl, wcomp1_avg, wcomp1_avg_ctl, ucomp2_avg, ucomp2_avg_ctl, wcomp2_avg, wcomp2_avg_ctl, ucomp3_avg, ucomp3_avg_ctl, wcomp3_avg, wcomp3_avg_ctl, ucomp4_avg, ucomp4_avg_ctl, 
    wcomp4_avg, wcomp4_avg_ctl, (sphum1_avg - sphum1_avg_ctl)*1000, (sphum2_avg - sphum2_avg_ctl)*1000, (sphum3_avg - sphum3_avg_ctl)*1000, (sphum4_avg - sphum4_avg_ctl)*1000, 'AP-patch - AP', 'AM-same - AP', 'AM-same-2xCO2 ', 'AM-dark - AM-same', minval=-3., maxval=3., vertmult = 8000, minlat=-10., maxlat=10.)


quiver_plots_4_seperate_cases(runmin, runmax, 'ucorr_interplevs_quivers_4cases_deltatemp_fct_latweights_narrowscale_', dire, 'RdBu_r', landmaskxr, '$\Delta$ T (K)', ucomp1_avg, ucomp1_avg_ctl, wcomp1_avg, wcomp1_avg_ctl, ucomp2_avg, ucomp2_avg_ctl, wcomp2_avg, wcomp2_avg_ctl, ucomp3_avg, ucomp3_avg_ctl, wcomp3_avg, wcomp3_avg_ctl, ucomp4_avg, ucomp4_avg_ctl, 
    wcomp4_avg, wcomp4_avg_ctl, (temp1_avg - temp1_avg_ctl), (temp2_avg - temp2_avg_ctl), (temp3_avg - temp3_avg_ctl), (temp4_avg - temp4_avg_ctl), 'AP-patch - AP', 'AM-same - AP', 'AM-same-2xCO2 ', 'AM-dark - AM-same', minval=-5., maxval=5., vertmult = 8000, minlat=-10., maxlat=10.)
