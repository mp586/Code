...
HPC = 'yes'
control_dir = 'squareland_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref1'
...
HPC = 'yes'
testdir_in1= 'squareland_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_plus_uniform_warming_and_2xCO2_spinup_121'
runmin=24
runmax=120
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
axes[0].set_title('Squareland control (SQ)', fontsize = med)
...
axes[1].set_title('Squareland perturbed (SQ)', fontsize = med)
...
axes[2].set_title('Squareland Perturbed - control (SQ)', fontsize = med)
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/squareland_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_plus_uniform_warming_and_2xCO2_spinup_121/w3000_SQ_control_perturbed_delta.png')
...
cset1 = plt.contourf(Xar[30:,60:110], Zar[30:,60:110], array_tropmean[30:,60:110], v, cmap='BrBG', extend = 'both')
plt.xlabel('Longitude E', fontsize = med)
plt.ylabel('Pressure (hPa)', fontsize = med)

Q = plt.quiver(X[0:10,60:110], Z[0:10,60:110], uwind_tropmean[0:10,60:110], wwind_tropmean[0:10,60:110], scale = 50, scale_units = 'inches') # if angle isn't set to 'xy', can't invert yaxis on quivers, but angle 'xy' doesn't plot quivers of (u,u) in 45 degree angle! angle 'uv' which is the default does and that's what I want
...
plt.title('SQ Pert-Control', fontsize = med)
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/squareland_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_plus_uniform_warming_and_2xCO2_spinup_121/w3000_SQ_perturbed-control_lower_atmosphere.png')
