...
HPC = 'yes'
control_dir = 'flat_continents_newbucket_fixedSSTs_from_realworld_zonallysymm_commitfe93b9d'
...
HPC = 'yes'
testdir_in1= 'flat_continents_newbucket_fixedSSTs_from_realworld_zonallysymm_plus_uniform_warming_and_2xCO2_spinup_361_commitfe93b9d'
runmin=120
runmax=480
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
HPC = 'yes'
testdir_in1= 'flat_continents_newbucket_fixedSSTs_from_realworld_zonallysymm_corrected_vegpref05_plus_uniform_warming_and_2xCO2_spinup_361_commitfe93b9d'
dire = testdir_in1
runmin=120
runmax=480
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
axes[1].set_title('(b) 50%cond', size = med)
#fig = plt.figure()
...
axes[0].set_title('(a) bucket', size = med)
#fig = plt.figure()
...
# cont = m.contour(xi,yi,ctl_array,nmb_contours, cmap = 'Greys', linewidth=4) # if nmb_contours is not an int, it can be interpreted as an array specifying the contour levels
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/Pavg_minus_ctl_bucket_vs_VP05_noconts_40S40N_120-480_paper.png', bbox_inches='tight', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/Pavg_minus_ctl_bucket_vs_VP05_noconts_40S40N_120-480_paper.eps', bbox_inches='tight', dpi=600)
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/Pavg_minus_ctl_bucket_vs_VP05_noconts_40S40N_120-480_paper.pdf', bbox_inches='tight', dpi=400)
