...
axes[0].set_title('(a) FCVP05', size = med)
#fig = plt.figure()
...
axes[1].set_title('(b) 2CVP05', size = med)
#fig = plt.figure()
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/flat_continents_newbucket_fixedSSTs_zonally_symmetric_vegetation_vegpref05_plus_2pt52K_and_2xCO2_spinup_361/P_avg_minus_ctl_2panels_idealized_flat_VP05_24-120.png', bbox_inches='tight', dpi=100)
