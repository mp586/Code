...
axes[0].set_title('narrow_three control (N3)', fontsize = med)
...
axes[1].set_title('narrow_three perturbed (N3)', fontsize = med)
...
axes[2].set_title('narrow_three Perturbed - control (N3)', fontsize = med)
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/narrow_three_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_plus_uniform_warming_and_2xCO2_spinup_121/w3000_SQ_control_perturbed_delta.png')
...
plt.title('N3 Pert-Control', fontsize = med)
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/narrow_three_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_plus_uniform_warming_and_2xCO2_spinup_121/w3000_SQ_perturbed-control_lower_atmosphere.png')
