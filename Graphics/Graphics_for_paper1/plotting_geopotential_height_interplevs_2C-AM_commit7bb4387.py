...
[gph1,gph1_avg,gph1_seasonal_avg,gph1_month_avg,gph1_annual_avg,time]=seasonal_4D_variable_interp(testdir,model,runmin,runmax,'height','m')
[gph1_ctl,gph1_avg_ctl,gph1_seasonal_avg_ctl,gph1_month_avg_ctl,gph1_annual_avg_ctl,time]=seasonal_4D_variable_interp(control_dir,ctl_model,ctl_runmin,ctl_runmax,'height','m')
...
[vcomp2,vcomp2_avg,vcomp2_seasonal_avg,vcomp2_month_avg,vcomp2_annual_avg,time]=seasonal_4D_variable_interp(testdir,model,runmin,runmax,'vcomp','m/s')
[vcomp2_ctl,vcomp2_avg_ctl,vcomp2_seasonal_avg_ctl,vcomp2_month_avg_ctl,vcomp2_annual_avg_ctl,time]=seasonal_4D_variable_interp(control_dir,ctl_model,ctl_runmin,ctl_runmax,'vcomp','m/s')
[gph2,gph2_avg,gph2_seasonal_avg,gph2_month_avg,gph2_annual_avg,time]=seasonal_4D_variable_interp(testdir,model,runmin,runmax,'height','m')
[gph2_ctl,gph2_avg_ctl,gph2_seasonal_avg_ctl,gph2_month_avg_ctl,gph2_annual_avg_ctl,time]=seasonal_4D_variable_interp(control_dir,ctl_model,ctl_runmin,ctl_runmax,'height','m')
...
minmax = [-20.,20.,-30.,30.]
nmb_contours = 30
plt_title = ['a) '+str(int(ucomp1_avg.pres_lev[level[0]]))+'hPa', 'b) '+str(int(ucomp1_avg.pres_lev[level[1]]))+'hPa']
j = 0 
for i in range(2):
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca'+outdir+'/gph_change_epx2_minus_exp1_interplevs_lev_'+str(level)+'_commit7bb4387.png', bbox_inches = 'tight')
# fig.savefig('/scratch/mp586/Code/Graphics/Isca'+outdir+'/gph_change_epx2_minus_exp1_interplevs_commit7bb4387.svg', bbox_inches = 'tight')
# fig.savefig('/scratch/mp586/Code/Graphics/Isca'+outdir+'/gph_change_epx2_minus_exp1_interplevs_commit7bb4387.pdf', bbox_inches = 'tight', dpi = 400)
