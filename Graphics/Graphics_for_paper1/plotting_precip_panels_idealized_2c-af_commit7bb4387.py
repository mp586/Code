...
array = (precipitation2_avg - precipitation2_avg_ctl) - (precipitation3_avg - precipitation3_avg_ctl)
...
landmask2 = np.asarray(landmaskxrSA)


axes.set_title('2C - AF', size = lge)
#fig = plt.figure()
...
m.drawmeridians(np.arange(-180.,180.,60),labels=[0,0,0,0], fontsize=med)
...
# Add Colorbar
cbar = fig.colorbar(cs, orientation = 'vertical', shrink = 0.9) 
cbar.set_label('mm/d', size=med)
cbar.ax.tick_params(labelsize=med)

# SAVE BY HAND as ....
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/Pavg_minus_ctl_2c-af_P-Econts_120-480_nomerids.png', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/Pavg_minus_ctl_2c-af_P-Econts_120-480_nomerids.svg', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/Pavg_minus_ctl_2c-af_P-Econts_120-480_nomerids.pdf', dpi=400)
