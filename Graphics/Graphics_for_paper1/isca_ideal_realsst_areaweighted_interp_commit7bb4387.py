...
[specper,specper_avg,specper_seasonal_avg,specper_month_avg,time]=seasonal_surface_variable_interp(testdir,model,runmin,runmax,'sphum','kg/kg',level=0)
[relper,relper_avg,relper_seasonal_avg,relper_month_avg,time]=seasonal_surface_variable_interp(testdir,model,runmin,runmax,'rh','%',level=0)
...
[speccon,speccon_avg,speccon_seasonal_avg,speccon_month_avg,time]=seasonal_surface_variable_interp(control_dir,ctl_model,ctl_runmin,ctl_runmax,'sphum','kg/kg',level=0)
[relcon,relcon_avg,relcon_seasonal_avg,relcon_month_avg,time]=seasonal_surface_variable_interp(control_dir,ctl_model,ctl_runmin,ctl_runmax,'rh','%',level=0)
...
fig.savefig('/scratch/mp586/Code/Graphics/isca_simple_scaling_plot_areaweighted_interp_commit7bb4387.png', bbox_inches='tight', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/isca_simple_scaling_plot_areaweighted_interp_commit7bb4387.pdf', bbox_inches='tight', dpi=400)
fig.savefig('/scratch/mp586/Code/Graphics/isca_simple_scaling_plot_areaweighted_interp_commit7bb4387.svg', bbox_inches='tight', dpi=100)
...
fig.savefig('/scratch/mp586/Code/Graphics/isca_simple_scaling_plot_main_extendaxes_areaweighted_interp_commit7bb4387.png', bbox_inches='tight', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/isca_simple_scaling_plot_main_extendaxes_areaweighted_interp_commit7bb4387.pdf', bbox_inches='tight', dpi=400)
fig.savefig('/scratch/mp586/Code/Graphics/isca_simple_scaling_plot_main_extendaxes_areaweighted_interp_commit7bb4387.svg', bbox_inches='tight', dpi=100)
...
fig.savefig('/scratch/mp586/Code/Graphics/isca_simple_scaling_plot_q_vs_r_areaweighted_interp_commit7bb4387.png', bbox_inches='tight', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/isca_simple_scaling_plot_q_vs_r_areaweighted_interp_commit7bb4387.pdf', bbox_inches='tight', dpi=400)
fig.savefig('/scratch/mp586/Code/Graphics/isca_simple_scaling_plot_q_vs_r_areaweighted_interp_commit7bb4387.svg', bbox_inches='tight', dpi=100)
