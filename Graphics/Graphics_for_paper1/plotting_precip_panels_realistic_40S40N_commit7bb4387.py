...
HPC = 'yes'
control_dir = 'full_continents_lepref07_fixedSSTs_zonally_symmetric' # checked for month 1 that this is the same if using comm7bb4387
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
    control_dir= control_model + '/ISCA_HPC/' + control_dir
else: 
    control_dir= control_model + '/' + control_dir
...
HPC = 'yes'
testdir_in1= 'full_continents_lepref07_fixedSSTs_zonally_symmetric_plus_2pt52K_and_2xCO2_spinup_361' # used same commit nr as spin-up, so equally will be the same with comm7bb4387
runmin=120
runmax=480
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
axes[1].set_title('(b) RC07', size = med)
#fig = plt.figure()
...
array = precipitation1_avg - precipitation1_avg_ctl - (precipitation2_avg - precipitation2_avg_ctl)
...
axes[2].set_title('(c) RC - RC07', size = med)
#fig = plt.figure()
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/full_continents_newbucket_fixedSSTs_zonally_symmetric_plus_2pt52K_and_2xCO2_spinup_361_commit7bb4387/Pavg_minus_ctl_2panels_RC_vs_RC07_P-Econts_40S40N_120-480.png', bbox_inches='tight', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/full_continents_newbucket_fixedSSTs_zonally_symmetric_plus_2pt52K_and_2xCO2_spinup_361_commit7bb4387/Pavg_minus_ctl_2panels_RC_vs_RC07_P-Econts_40S40N_120-480.svg', bbox_inches='tight', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/full_continents_newbucket_fixedSSTs_zonally_symmetric_plus_2pt52K_and_2xCO2_spinup_361_commit7bb4387/Pavg_minus_ctl_2panels_RC_vs_RC07_P-Econts_40S40N_120-480.pdf', bbox_inches='tight', dpi=400)
