...
# Add Colorbar
cbar = fig.colorbar(cs, orientation = 'vertical', shrink = 0.65) 
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/Pavg_minus_ctl_2c-af_P-Econts_120-480_nomerids.pdf')