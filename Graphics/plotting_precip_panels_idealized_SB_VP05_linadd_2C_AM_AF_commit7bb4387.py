...
axes[0,0].set_title('(a) Two Continents (2C) SB', size = med)
#fig = plt.figure()
...
axes[0,1].set_title('(b) Two continents (2C) VP05', size = med)
#fig = plt.figure()
...
axes[1,0].set_title('(c) America (AM) VP05', size = med)
#fig = plt.figure()
...
array = (precipitation3_avg - precipitation3_avg_ctl) - ((precipitation1_avg - precipitation1_avg_ctl) + (precipitation2_avg - precipitation2_avg_ctl))
...
axes[1,1].set_title('(d) 2C VP05 - (AM VP05 + 2C SB)', size = med)
#fig = plt.figure()
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/P_avg_minus_ctl_2C_AM_SB_VP05_linadd.png', bbox_inches = 'tight')
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/P_avg_minus_ctl_2C_AM_SB_VP05_linadd.pdf', bbox_inches = 'tight', dpi=400)