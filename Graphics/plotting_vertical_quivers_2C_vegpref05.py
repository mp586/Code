...
axes[0].set_title('2C control', fontsize = med)
...
axes[1].set_title('2C perturbed', fontsize = med)
...
axes[2].set_title('2C perturbed - control', fontsize = med)
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/two_continents_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref05_plus_uniform_warming_and_2xCO2_spinup_121/w3000_SQ_control_perturbed_delta.png')
...
plt.title('2C Pert-Control', fontsize = med)
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/two_continents_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref05_plus_uniform_warming_and_2xCO2_spinup_121/w3000_SQ_perturbed-control_lower_atmosphere.png')
