...
HPC = 'yes'
control_dir = 'narrow_twelve_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref1'
...
HPC = 'yes'
testdir_in1= 'narrow_twelve_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_plus_uniform_warming_and_2xCO2_spinup_121'
runmin=24
runmax=120
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
axes[0].set_title('narrow_twelve control (N12)', fontsize = med)
...
axes[1].set_title('narrow_twelve perturbed (N12)', fontsize = med)
...
axes[2].set_title('narrow_twelve Perturbed - control (N12)', fontsize = med)
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/narrow_twelve_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_plus_uniform_warming_and_2xCO2_spinup_121/w3000_SQ_control_perturbed_delta.png')
...
cset1 = plt.contourf(Xar[30:,50:80], Zar[30:,50:80], array_tropmean[30:,50:80], v, cmap='BrBG', extend = 'both')
...
plt.title('N12 Pert-Control', fontsize = med)
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/narrow_twelve_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_plus_uniform_warming_and_2xCO2_spinup_121/w3000_SQ_perturbed-control_lower_atmosphere.png')
