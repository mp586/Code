...
HPC = 'no'
testdir_in1= 'full_continents_newbucket_fixedSSTs_zonally_symmetric_vegetation_vegpref05_plus_2pt52K_and_2xCO2_spinup_361'
runmin=24
runmax=120
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/two_continents_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref05_plus_uniform_warming_and_2xCO2_spinup_121/w8000_RC_Flat_2C_veg05_pert_minus_control.png')

any_configuration_plot(outdir,runmin,runmax,-90.,90.,rh3_avg[39,:,:] - rh3_avg_ctl[39,:,:],area_array,'%','rh_avg_minus_ctl_lev39','rainnorm',landmaskxr,nmb_contours=5, minval=-7., maxval = 7.)
any_configuration_plot(outdir,runmin,runmax,-90.,90.,rh1_avg[39,:,:] - rh1_avg_ctl[39,:,:],area_array,'%','rh_avg_minus_ctl_lev39','rainnorm',landmaskxr,nmb_contours=5, minval=-7., maxval = 7.)
any_configuration_plot(outdir,runmin,runmax,-90.,90.,rh2_avg[39,:,:] - rh2_avg_ctl[39,:,:],area_array,'%','rh_avg_minus_ctl_lev39','rainnorm',landmaskxr,nmb_contours=5, minval=-7., maxval = 7.)
