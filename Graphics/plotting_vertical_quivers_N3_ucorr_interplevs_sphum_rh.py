...
quivers_2cases(runmin, runmax, 'ucorr_interp_quivers_2cases_SBvCV05_deltarh_fct', dire, '$\Delta RH$ (%)', ucomp1_avg, ucomp1_avg_ctl, wcomp1_avg, wcomp1_avg_ctl, ucomp2_avg, ucomp1_avg_ctl, wcomp2_avg, wcomp1_avg_ctl, (rh1_avg - rh1_avg_ctl), (rh2_avg - rh1_avg_ctl), minval=-10., maxval=10., vertmult=8000, minlat=-10., maxlat=10.)
quivers_2cases(runmin, runmax, 'ucorr_interp_quivers_2cases_SBvCV05_deltasphum_fct', dire, '$\Delta q$ (kg/kg)', ucomp1_avg, ucomp1_avg_ctl, wcomp1_avg, wcomp1_avg_ctl, ucomp2_avg, ucomp1_avg_ctl, wcomp2_avg, wcomp1_avg_ctl, (sphum1_avg - sphum1_avg_ctl), (sphum2_avg - sphum1_avg_ctl), minval=-.003, maxval=.003, vertmult=8000, minlat=-10., maxlat=10.)
quivers_2cases(runmin, runmax, 'ucorr_interp_quivers_2cases_SBvCV05_deltatemp_fct', dire, '$\Delta T$ (K)', ucomp1_avg, ucomp1_avg_ctl, wcomp1_avg, wcomp1_avg_ctl, ucomp2_avg, ucomp1_avg_ctl, wcomp2_avg, wcomp1_avg_ctl, (temp1_avg - temp1_avg_ctl), (temp2_avg - temp1_avg_ctl), minval=-10., maxval=10., vertmult=8000, minlat=-10., maxlat=10., cmap = 'RdBu_r')
