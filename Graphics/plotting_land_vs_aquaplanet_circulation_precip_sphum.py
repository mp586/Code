...
HPC = 'yes'
control_dir = 'aquaplanet_fixedSSTs_from_realworld_zonallysymm'
...
HPC = 'yes'
testdir_in1= 'aquaplanet_fixedSSTs_from_realworld_zonallysymm_plus_uniform_warming_and_2xCO2_spinup_361'
runmin=24
runmax=120
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
HPC = 'yes'
testdir_in1= 'square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_plus_uniform_warming_and_2xCO2_spinup_121'
runmin=24
runmax=120
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
axes[0].set_title('Aquaplanet (AP) control', fontsize = med)
axes[0].set_xlabel('Longitude E', fontsize = med)
cbar = plt.colorbar(cset1, orientation = 'vertical', ax = axes[0])
...
axes[1].set_title('South America (AM) control', fontsize = med)
axes[1].set_xlabel('Longitude E', fontsize = med)
cbar = plt.colorbar(cset1, orientation = 'vertical', ax = axes[1])
cbar.ax.tick_params(labelsize=small)
cbar.set_label('$RH$ (%)', size = med)
# Two continents 
...
wwind = ((wcomp2_avg_ctl - wcomp1_avg_ctl)*8000.)[::-1,:,:]
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_plus_uniform_warming_and_2xCO2_spinup_121/w3000_AP_AM_w8000_AM_minus_AP_control.png')

any_configuration_plot(outdir,runmin,runmax,-90.,90.,rh2_avg_ctl[39,:,:] - rh1_avg_ctl[39,:,:],area_array,'%','rh_ctl_AM_minus_AP','rainnorm',landmaskxr,nmb_contours=5, minval=-10., maxval = 10.)
any_configuration_plot(outdir,runmin,runmax,-90.,90.,precipitation2_avg_ctl - precipitation1_avg_ctl,area_array,'mm/d','P_ctl_AM_minus_AP','rainnorm',landmaskxr,nmb_contours=5, minval=-2., maxval = 2.)
any_configuration_plot(outdir,runmin,runmax,-90.,90.,t_surf2_avg_ctl - t_surf1_avg_ctl,area_array,'K','tsurf_ctl_AM_minus_AP','tempdiff',landmaskxr, minval = -10, maxval = 10.,steps=21)
...
Q = axes[0].quiver(X[::2,::2], Z[::2,::2], uwind_tropmean[::2,::2], wwind_tropmean[::2,::2], scale = 50, scale_units = 'inches') # if angle isn't set to 'xy', can't invert yaxis on quivers, but angle 'xy' doesn't plot quivers of (u,u) in 45 degree angle! angle 'uv' which is the default does and that's what I want
# in order for the vectors to all be the same length on all panels and quiverkey to apply to all of them, set scale and scale_units 
axes[0].set_title('Aquaplanet (AP) perturbed', fontsize = med)
axes[0].set_xlabel('Longitude E', fontsize = med)
cbar = plt.colorbar(cset1, orientation = 'vertical', ax = axes[0])
cbar.ax.tick_params(labelsize=small)
cbar.set_label('$RH$ (%)', size = med)
...
Q = axes[1].quiver(X[::2,::2], Z[::2,::2], uwind_tropmean[::2,::2], wwind_tropmean[::2,::2], scale = 50, scale_units = 'inches') # if angle isn't set to 'xy', can't invert yaxis on quivers, but angle 'xy' doesn't plot quivers of (u,u) in 45 degree angle! angle 'uv' which is the default does and that's what I want
#qk = axes[1].quiverkey(Q, 0.9, 0.9, veclen, str(veclen)+r'$\frac{'+units_numerator+'}{'+units_denom+'}$', labelpos='E', coordinates='figure')
axes[1].set_title('South America (AM) perturbed', fontsize = med)
axes[1].set_xlabel('Longitude E', fontsize = med)
cbar = plt.colorbar(cset1, orientation = 'vertical', ax = axes[1])
cbar.ax.tick_params(labelsize=small)
cbar.set_label('$RH$ (%)', size = med)
...
uwind = (ucomp2_avg - ucomp1_avg)
wwind = ((wcomp2_avg - wcomp1_avg)*8000.)[::-1,:,:]
array = (rh2_avg - rh1_avg)
lons = uwind.lon
lats = uwind.lat
pres = wwind.pres_lev
presar = array.pres_lev # need separate z coords for winds because read them in in reverse z order to flip axis
...
Q = axes[2].quiver(X[::2,::2], Z[::2,::2], uwind_tropmean[::2,::2], wwind_tropmean[::2,::2], scale = 50, scale_units = 'inches') # if angle isn't set to 'xy', can't invert yaxis on quivers, but angle 'xy' doesn't plot quivers of (u,u) in 45 degree angle! angle 'uv' which is the default does and that's what I want
#qk = axes[2].quiverkey(Q, 0.9, 0.9, veclen, str(veclen)+r'$\frac{'+units_numerator+'}{'+units_denom+'}$', labelpos='E', coordinates='figure')
axes[2].set_title('AM - AP (perturbed)', fontsize = med)
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_plus_uniform_warming_and_2xCO2_spinup_121/w3000_AP_AM_w8000_AM_minus_AP_perturbed.png')

any_configuration_plot(outdir,runmin,runmax,-90.,90.,rh2_avg[39,:,:] - rh1_avg[39,:,:],area_array,'%','rh_avg_AM_minus_AP','rainnorm',landmaskxr,nmb_contours=5, minval=-10., maxval = 10.)
any_configuration_plot(outdir,runmin,runmax,-90.,90.,precipitation2_avg - precipitation1_avg,area_array,'mm/d','P_avg_AM_minus_AP','rainnorm',landmaskxr,nmb_contours=5, minval=-2., maxval = 2.)
any_configuration_plot(outdir,runmin,runmax,-90.,90.,t_surf2_avg - t_surf1_avg,area_array,'K','tsurf_avg_AM_minus_AP','tempdiff',landmaskxr, minval = -10, maxval = 10.,steps=21)
...
Q = axes[0].quiver(X[::2,::2], Z[::2,::2], uwind_tropmean[::2,::2], wwind_tropmean[::2,::2], scale = 50, scale_units = 'inches') # if angle isn't set to 'xy', can't invert yaxis on quivers, but angle 'xy' doesn't plot quivers of (u,u) in 45 degree angle! angle 'uv' which is the default does and that's what I want
# in order for the vectors to all be the same length on all panels and quiverkey to apply to all of them, set scale and scale_units 
axes[0].set_title('Aquaplanet (AP) perturbed - control', fontsize = med)
axes[0].set_xlabel('Longitude E', fontsize = med)
cbar = plt.colorbar(cset1, orientation = 'vertical', ax = axes[0])
cbar.ax.tick_params(labelsize=small)
cbar.set_label('$RH$ (%)', size = med)
...
Q = axes[1].quiver(X[::2,::2], Z[::2,::2], uwind_tropmean[::2,::2], wwind_tropmean[::2,::2], scale = 50, scale_units = 'inches') # if angle isn't set to 'xy', can't invert yaxis on quivers, but angle 'xy' doesn't plot quivers of (u,u) in 45 degree angle! angle 'uv' which is the default does and that's what I want
#qk = axes[1].quiverkey(Q, 0.9, 0.9, veclen, str(veclen)+r'$\frac{'+units_numerator+'}{'+units_denom+'}$', labelpos='E', coordinates='figure')
axes[1].set_title('South America (AM) perturbed - control', fontsize = med)
axes[1].set_xlabel('Longitude E', fontsize = med)
cbar = plt.colorbar(cset1, orientation = 'vertical', ax = axes[1])
cbar.ax.tick_params(labelsize=small)
cbar.set_label('$RH$ (%)', size = med)
...
uwind = (ucomp2_avg - ucomp2_avg_ctl - ucomp1_avg + ucomp1_avg_ctl)
...
Q = axes[2].quiver(X[::2,::2], Z[::2,::2], uwind_tropmean[::2,::2], wwind_tropmean[::2,::2], scale = 50, scale_units = 'inches') # if angle isn't set to 'xy', can't invert yaxis on quivers, but angle 'xy' doesn't plot quivers of (u,u) in 45 degree angle! angle 'uv' which is the default does and that's what I want
#qk = axes[2].quiverkey(Q, 0.9, 0.9, veclen, str(veclen)+r'$\frac{'+units_numerator+'}{'+units_denom+'}$', labelpos='E', coordinates='figure')
axes[2].set_title('AM - AP (perturbed - control)', fontsize = med)
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_plus_uniform_warming_and_2xCO2_spinup_121/w8000_AM_minus_AP_perturbed_minus_ctl.png')

any_configuration_plot(outdir,runmin,runmax,-90.,90.,(rh2_avg - rh2_avg_ctl - rh1_avg + rh1_avg_ctl)[39,:,:],area_array,'%','rh_avg_minus_ctl_AM_minus_AP','rainnorm',landmaskxr,nmb_contours=5, minval=-10., maxval = 10.)
any_configuration_plot(outdir,runmin,runmax,-90.,90.,precipitation2_avg - precipitation2_avg_ctl - precipitation1_avg + precipitation1_avg_ctl,area_array,'mm/d','P_avg_minus_ctl_AM_minus_AP','rainnorm',landmaskxr,nmb_contours=5, minval=-2., maxval = 2.)
any_configuration_plot(outdir,runmin,runmax,-90.,90.,t_surf2_avg - t_surf2_avg_ctl - t_surf1_avg + t_surf1_avg_ctl,area_array,'K','tsurf_avg_minus_ctl_AM_minus_AP','tempdiff',landmaskxr, minval = -10, maxval = 10.,steps=21)
