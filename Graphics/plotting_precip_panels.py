...
axes[2].set_title('Two continents')
#fig = plt.figure()

m = Basemap(projection='kav7',lon_0=0.,resolution='c', ax = axes[2])
array = xr.DataArray(array,coords=[lats,lons],dims=['lat','lon'])
...
# Add Colorbar
cbar = fig.colorbar(cs, orientation = 'vertical', ax = axes, shrink = 0.3, fraction = 0.1) # usually on right 
cbar.set_label('mm/d', size=med)
cbar.ax.tick_params(labelsize=med)

fig.savefig('/scratch/mp586/Code/Graphics/Isca/square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_plus_uniform_warming_and_2xCO2_spinup_361/Pavg_minus_ctl_3panels_2c_africa_america_P-Econts_120-480.png', bbox_inches='tight', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/Isca/square_South_America_newbucket_fixedSSTs_from_realworld_zonallysymm_plus_uniform_warming_and_2xCO2_spinup_361/Pavg_minus_ctl_3panels_2c_africa_america_P-Econts_120-480.svg', bbox_inches='tight', dpi=100)
