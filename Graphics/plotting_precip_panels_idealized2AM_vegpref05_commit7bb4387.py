...
HPC = 'yes'
control_dir = 'two_AM_newbucket_fixedSSTs_from_realworld_zonallysymm_commita464158'
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
    control_dir= control_model + '/ISCA_HPC/' + control_dir
else: 
    control_dir= control_model + '/' + control_dir
...
HPC = 'yes'
testdir_in1= 'two_AM_newbucket_fixedSSTs_from_realworld_zonallysymm_corrected_vegpref05_plus_uniform_warming_and_2xCO2_spinup_361_commita464158'
dire = testdir_in1
...
axes[1,0].set_title('(c) Two Americas (2AM) VP05', size = med)
#fig = plt.figure()
...
axes[1,1].set_title('(d) 2AM - AM VP05', size = med)
#fig = plt.figure()
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/P_avg_minus_Ctl_4cases_'+str(runmin)+'-'+str(runmax)+'.png')
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/P_avg_minus_Ctl_4cases_'+str(runmin)+'-'+str(runmax)+'.svg')
