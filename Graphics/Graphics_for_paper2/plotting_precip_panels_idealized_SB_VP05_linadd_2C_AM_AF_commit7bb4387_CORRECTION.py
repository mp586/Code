...
axes[1,0].set_title('(c) AM 50%cond - AM bucket', size = med)
#fig = plt.figure()
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/P_avg_minus_ctl_2C_AM_SB_VP05_linadd_CORRECTION.png', bbox_inches = 'tight')
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/P_avg_minus_ctl_2C_AM_SB_VP05_linadd_CORRECTION.pdf', bbox_inches = 'tight', dpi=400)