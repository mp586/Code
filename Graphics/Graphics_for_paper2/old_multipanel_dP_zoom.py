...
names = ['0%cond', '50%cond']
conts = ['3$^{\circ}$','6$^{\circ}$','AM']
...
plt.savefig('/scratch/mp586/Code/Graphics/multipanel_zoom_'+variable+'_avg_minus_ctl_120-480_lowcbar.png', bbox_inches = 'tight', format = 'png', dpi = 400)
plt.savefig('/scratch/mp586/Code/Graphics/multipanel_zoom_'+variable+'_avg_minus_ctl_120-480_lowcbar.pdf', bbox_inches = 'tight', format = 'pdf')
