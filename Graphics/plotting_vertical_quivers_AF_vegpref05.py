...
HPC = 'yes'
testdir_in1= 'squareland_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref05_plus_uniform_warming_and_2xCO2_spinup_121'
runmin=24
runmax=120
if (HPC == 'Yes') or (HPC == 'yes') or (HPC == 'y'):
...
# axes[0].set_title('Square Africa control', fontsize = med)
...
# axes[1].set_title('Square Africa perturbed', fontsize = med)
...
# axes[2].set_title('Square Africa Perturbed - control', fontsize = med)
...
# fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/squareland_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref0_plus_uniform_warming_and_2xCO2_spinup_121/w8000_control_perturbed_delta.png')
...
Q = plt.quiver(X[::3,::3], Z[::3,::3], uwind_tropmean[::3,::3], wwind_tropmean[::3,::3], scale = 50, scale_units = 'inches') # if angle isn't set to 'xy', can't invert yaxis on quivers, but angle 'xy' doesn't plot quivers of (u,u) in 45 degree angle! angle 'uv' which is the default does and that's what I want
...
plt.title('SQ05 Pert-Control', fontsize = med)
...
plt.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/squareland_newbucket_fixedSSTs_from_realworld_zonallysymm_vegetation_vegpref05_plus_uniform_warming_and_2xCO2_spinup_121/w8000_perturbed-control.png')
