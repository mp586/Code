...
axes[1].set_title('(b) 2C - AM (VP05)', size = med)
#fig = plt.figure()
...
array =  precipitation3_avg - precipitation3_avg_ctl - (precipitation1_avg  - precipitation1_avg_ctl) - ((precipitation4_avg - precipitation4_avg_ctl) - (precipitation2_avg - precipitation2_avg_ctl))

lats=array.lat
lons=array.lon

axes[2].set_title('(c) 2C - AM (SB - VP05)', size = med)
#fig = plt.figure()
...
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/Pavg_minus_ctl_bucket_vs_VP05_2C-AM_40S40N_120-480.png', bbox_inches='tight', dpi=100)
fig.savefig('/scratch/mp586/Code/Graphics/Isca/ISCA_HPC/'+dire+'/Pavg_minus_ctl_bucket_vs_VP05_2C-AM_40S40N_120-480.pdf', bbox_inches='tight', dpi=400)
